...
print(naive_exponentiation(2,0,10)== 2**0 %10)
print(naive_exponentiation(2,1,10)== 2**1 %10)
print(naive_exponentiation(2,6,10)== 2**6 %10)
print(naive_exponentiation(-2,6,10)== (-2)**6 %10)
print(naive_exponentiation(2,6,-10)== 2**6 % 10)
...
de fonction de test à la fin du fichier
"""
...
"""
répondre ici aux items 1,2,3 pour la courbe P256
"""
...
c = encipher(m,n,e)
print("chiffrement de ",m,":", c)
print("déchiffrement de ",c,":", decipher_CRT(c,n,p,q,dp,dq,invp,invq))
"""
...
print("Génération d'une mauvaise bi-clé")
k=2048
